...
function convertStringBool(value) {
...
function getConfig() {
  ...
  dataset.useLocalCache = convertStringBool(dataset.useLocalCache);
  dataset.performHash = convertStringBool(dataset.performHash);
  dataset.rewriteSourcemaps = convertStringBool(dataset.rewriteSourcemaps);
  return dataset;
}
